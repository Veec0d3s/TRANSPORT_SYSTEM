...
Passenger browses available journeys
Selects route, date, and seats
Confirms booking with wallet payment
Receives booking confirmation with QR code
Taps in at boarding using QR code
Journey tracked in real-time
Automatic completion upon arrival
Rate and review the journey
Driver Journey Flow
Driver logs in and views assigned journeys
Monitors real-time passenger tap-ins
Receives notifications for new boardings
Tracks occupancy percentage
Marks journey as completed
Views earnings and passenger ratings
Admin Operations Flow
Create routes with stops and fares
Add and assign buses to drivers
Schedule journeys on routes
